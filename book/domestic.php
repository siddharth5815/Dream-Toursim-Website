      ...
      <form action="domesticuserinfo.php" method="post">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="tour" id="sel1">
            <option>Agra Tour</option>
    <option>Goa Tour</option>
    <option>South India Tour</option>
    <option>Jammu Kashmir Tour</option>
    <option>Himachal Tour</option>
    <option>Gujrat Tour</option>
    </select>
        </div>
        <div class="form-group">
